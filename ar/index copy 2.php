	...
	<section class="services-section-two arabic-section"
		...
		<div class="container">
			...
			<div class="section-title light centered ">
				...
				<h3 class="text-center">كاسب محمد الحسني (الرئيس التنفيذي)</h3>
			</div>
							...
							<div class="testimonial-block">
								<div class="inner-box">
									<div class="testimonial-content">
										...
										<div class="text txtalkaseeb">	15
										 عام من الخبرة العسكرية ومجال الامن ودرجة بكالوريوس في القانون من أكاديمية شرطة دبي ودرجة الماجستير في القانون الخاص من جامعة عجمان كاتب في مجال القانون وروائي ادبي يتحدث الانجليزي والهندية محامي وممارس مسجل في محاكم الدولة الاتحادية والمحلية
															</div>
										<!-- Lower Box -->
										<div class="lower-box">
											<div class="box-inner">
					...
					<div class="col-12 col-md-4">
						<div class="d-flex flex-column align-items-center gap-2" style="gap: 2rem">
							...
							<div class="text d-flex flex-column align-items-center" style="gap: 1rem">
								...
								<p style="text-align: center; width: 80%">
								لمستشار كاسب محمد الحساني نحن نأخذ عملائنا على نهج الثقة لازالة مخاوفهم وفهم ظروفكم لازالة القلق وفهم استراتيجياتكم لتلبية احتياجكم وتكييفنا القانوني يضمن ذلك والتزامنا بالتوضيح والمصداقية في اعلامك بالتقدم المحرز دائماً
							</p>
							</div>
						</div>
