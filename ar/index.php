				...
				<div class="content-column col-lg-7 col-md-12 col-sm-12">
					<div class="inner-column">
						...
						<div class="section-title">
							...
							<h3>محامون استشاريون قانونيون</h3>
						</div>

						<div class="text">
							<p>مرحبا بكم في شركة الكاسيب للمحاماة والإستشارات القانونية. المستشار القانوني شريكك الموثوق 
								المسائل القانونية. نحن فريق من المدافعين ذوي الخبرة والتفاني و
								يلتزم المستشارون القانونيون بتقديم خدمات شاملة وشخصية
								الحلول القانونية للأفراد والشركات على حد سواء. شركتنا يقودها 
								الشغف بالعدالة وفهم عميق للقانون ، مما يمكننا من تحقيق 
	...
	<section class="services-section-two arabic-section"
		...
		<div class="container">
			...
			<div class="section-title light centered ">
				...
				<h3 class="text-center">   (الرئيس التنفيذي) كاسب محمد الحساني</h3>
			</div>
					...
					<div class="col-12 col-md-4">
						<div class="d-flex flex-column align-items-center gap-2" style="gap: 2rem">
							...
							<div class="text d-flex flex-column align-items-center" style="gap: 1rem">
								...
								سواء كنت تحتاج إلى مساعدة في المسائل القانونية الشخصية أو النزاعات التجارية المعقدة، فإننا نقدم مجموعة واسعة من الخدمات القانونية لتلبية متطلباتك. تمتد خبرتنا إلى التحكيم، والتفاوض، والقضايا المدنية والجنائية، وتحصيل الديون، وقانون الأسرة، وقانون العمل، والعقارات، وقانون الشركات التجارية، وعقود واتفاقيات الملكية الفكرية والمزيد.
								</p>				
								</div>
						</div>
					...
					<div class="col-12 col-md-4">
						<div class="d-flex flex-column align-items-center gap-2" style="gap: 2rem">
							...
							<div class="text d-flex flex-column align-items-center" style="gap: 1rem">
								...
								<p style="text-align: center; width: 80%">
								 نحن نأخذ عملائنا على نهج الثقة لازالة مخاوفكم وفهم ظروفكم لازالة القلق وفهم استراتيجياتكم لتلبية احتياجكم وتكييفنا القانوني يضمن ذلك والتزامنا بالتوضيح والمصداقية في اعلامك بالتقدم المحرز دائماً
							</p>
							</div>
						</div>
