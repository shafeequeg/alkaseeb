		...
		<div class="container">
			...
			<div class="mixitup-gallery">
				...
				<div class="filter-list row clearfix">
					...
					?>
					<div class="portfolio-block-two mix <?php echo $row['ar_category'] ?> col-lg-4 col-md-4 col-sm-6">
						<div class="inner-box">
							<div class="image">
								<img src="../en/alkaaseb_admin/uploads/products/<?php echo $row['photo'] ?>" alt="" />
								<div class="overlay-box">
									<a href="../en/alkaaseb_admin/uploads/products/<?php echo $row['photo'] ?>" data-fancybox="gallery-1" data-caption="" class="plus flaticon-plus"></a>
								</div>
							</div>
							<div class="lower-content">
								<h5><a href="details.php?id=<?php echo $row['product_id'] ?>"><?php echo $row['ar_title'] ?> </a></h5>
