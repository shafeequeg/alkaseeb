            ...
            <div class="m-content">
                ...
                <div class="m-portlet m-portlet--mobile m-portlet--mobile m-portlet--info m-portlet--head-solid-bg m-portlet--bordered m-portlet--rounded">
                    ...
                    <div class="m-portlet__body">
                        ...
                        <!--end: Search Form -->
                        <!--begin: Datatable -->
                        <table width="100%" class="table m-table nowrap table-header-fixed table-striped table-bordered table-hover table-header-fixed" id="product_view_table">
                            <thead>
                            <tr class="">
                                <th>ID</th>
                                <th>Title</th>
                        ...
                        <div class="modal fade" tabindex="-1" id="article_add_modal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog " role="document" style="max-width: 675px">
                                <div class="modal-content">
                                    ...
                                    <form id="form_article_add" method="post" action="<?php echo base_url().$user_directory.'portfolio/create'?>" class="m-form m-form--fit m-form--state m-form--label-align-right " enctype="multipart/form-data" >
                                        <div class="modal-body">
                                            <div class="m-form__content">
                                                <div class="m-alert m-alert--icon alert alert-warning m--hide" role="alert" id="form_article_add_msg">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12" >
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <select name="category" style="width: 100%;" class="form-control m-bootstrap-select m-bootstrap-select--air m-bootstrap-select--pill" id="cat">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12" >
                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <select name="ar_category" style="width: 100%;" class="form-control m-bootstrap-select m-bootstrap-select--air m-bootstrap-select--pill" id="catar">
                                                           
                                                            <option selected="selected" >Select Type</option>
                                                            <?php foreach ($category as $c):
                                    
                                                                echo "<option value='".$c->cat_id."'> ".$c->ar."</option>";
                                                            endforeach;?>
                                                ...
                                                <div class="col-lg-12" >
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group m-form__group">
                                                         ...
                                                         <input type="text" name="ar_title" class="form-control m-input" > 
                                                ...
                                                <div class="col-lg-12" >
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group m-form__group">
                                                         ...
                                                         <!-- <input type="text" name="en_desc" class="form-control m-input" id="">  -->
                                                         <textarea rows="8" cols="50" name="en_desc" class="form-control m-input"></textarea>
                                                ...
                                                <div class="col-lg-12" >
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group m-form__group">
                                                         ...
                                                         <!-- <input type="text" name="ar_desc" class="form-control m-input" id="">  -->
                                                         <textarea rows="8" cols="50" name="ar_desc" class="form-control m-input"></textarea>
                                                ...
                                                <div class="col-lg-12" >
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group m-form__group">
                                                         ...
                                                         <input type="text" name="title" class="form-control m-input" id="title1"> 
                                                ...
                                                <div class="col-lg-12" >
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group m-form__group">
                                                         ...
                                                         <input type="text" name="ar_title" class="form-control m-input" id="arTitle2"> 
                                                ...
                                                <div class="col-lg-12" >
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group m-form__group">
                                                         ...
                                                         <textarea rows="8" cols="50" name="en_desc" class="form-control m-input" id="en_desc1"></textarea>
                                                ...
                                                <div class="col-lg-12" >
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="form-group m-form__group">
                                                         ...
                                                         <textarea rows="8" cols="50" name="ar_desc" class="form-control m-input" id="ar_desc"></textarea>
                        ...
                        <div class="modal fade" tabindex="-1" id="article_delete_modal" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog " role="document" >
                                <form id="user_delete_form" action="<?php echo base_url().$user_directory.'portfolio/delete'?>" method="post" class="form-horizontal">
                                    <div class="modal-content">
