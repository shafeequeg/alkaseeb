...
//  User List Data Table
    var Datatable=function() {
        ...
        var t=function() {
                var table = $('#banner_view_table').DataTable({
                "ajax":{
                    url :"<?php echo base_url()?>admin/home/select_banner", // json datasource
...
<script>
     ...
     //   alert(no);
        ...
        $('#id').val(no.eq(0).text());
        $('#img1').val(no.eq(1).text());
        $('#title1').val(no.eq(3).text());
        $('#title2').val(no.eq(4).text());

        $('#artitle1').val(no.eq(5).text());
        $('#arsubtitle2').val(no.eq(6).text());
